...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo)
    values ('Carlos Ferreira', 'Rua Doutor Rui Maia', '633', 'Apartamento 102', 'Herval', '63900315', 'Quixadá', 'Ceará', true);
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo)
    values ('Gabriel Uchoa', 'Rua Doutor Rui Maia', '633', 'Apartamento 102', 'Herval', '63900315', 'Quixadá', 'Ceará', true);
INSERT INTO pessoa (nome, logradouro, numero, bairro, cep, cidade, estado, ativo)
    values ('Kevin Mailho', 'Avenida da Saudade', '2929', 'Passaré', '60856650', 'Fortaleza', 'Ceará', true);
